...
namespace test111binimoy.Controllers
{
    public class UserEditController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,email,username,Password")] Users users)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,email,username,Password")] Users users)
        {
            if (ModelState.IsValid)
            {
